          ...
          <ScrollView horizontal>
            <DataTable>
              <DataTable.Header>
                ...
                <DataTable.Title numeric>Password</DataTable.Title>
                <DataTable.Title numeric>License</DataTable.Title>
              ...
              {vehicles.length ? (
                vehicles.map((item) => (
                  <DataTable.Row key={item.id}>
                    ...
                    <DataTable.Cell numeric>{item.license}</DataTable.Cell>
                    <DataTable.Cell numeric>{item.contact}</DataTable.Cell>
